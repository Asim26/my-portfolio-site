      ...
      <div className="page">
        <nav id="colorlib-main-nav" role="navigation">
          ...
          <div className="js-fullheight colorlib-table">
            <div
              className="img"
              style={{ backgroundImage: "url(images/Asim.jpg)" }}
            />
          ...
          <section className="ftco-section about-section">
            <div className="container">
              <div className="row d-flex my-5" data-scrollax-parent="true">
                  ...
                  <div className="about-desc">
                    ...
                    <div className="p-5">
                      ...
                      <p>
                        ...
                        very well experience with React Js, JavaScript, PHP,
                        wordpress and Laravel. I am language independent and can
                        switch the technology very quicky.
                      </p>
                      {/* <p><a href="https://drive.google.com/file/d/1Q3E6gVq8ZTbklYzTVUhvVIPBsWNC8X5h/view?usp=sharing"><span>Checkout my resume</span></a></p> */}
                      ...
                      <ul className="ftco-footer-social list-unstyled mt-4">
                        ...
                        <li>
                          <a href="https://www.linkedin.com/in/asim-mehmood/">
                            <span className="icon-linkedin" />
                          </a>
                        </li>
                        <li>
                          <a href="https://github.com/Asim26">
                      ...
                      <p>
                        Email:{" "}
                        <a href="mohammadasimmehmood@gmail.com">
                          mohammadasimmehmood@gmail.com
                        </a>
                      </p>
                      <p>
                        Phone:{" "}
                        <a href="(+92)-323-72 25 238">(+92)-323-72 25 238</a>
                      </p>
                    </div>
                  </div>
                </div>
                <p>
                  <a
                    href="https://drive.google.com/file/d/1Q3E6gVq8ZTbklYzTVUhvVIPBsWNC8X5h/view?usp=sharing"
                  ...
                  <div className="exp mt-5 ftco-animate">
                    ...
                    <div className="exp-wrap py-4">
                      <div className="desc">
                        <h4>
                          Matriculation{" "}
                          <span> - District Public School Kasur</span>{" "}
                        </h4>
                ...
                <div className="col-md-5 col-sm-5 counter-wrap ftco-animate">
                  <div className="block-18">
                    <div className="text">
                      ...
                      <strong className="number" data-number={440}>
                        0
                      </strong>
                    </div>
                  </div>
                ...
                <div className="col-md-5 col-sm-5 counter-wrap ftco-animate">
                  <div className="block-18">
                    <div className="text">
                      ...
                      <strong className="number" data-number={630}>
                        0
                      </strong>
                    </div>
                  </div>
            ...
            <div className="container mt-5">
              <div className="row d-flex mb-5 contact-info">
                ...
                <div className="col-md-3">
                  <p>
                    <span>Phone:</span>{" "}
                    <a href="tel://+92 323 72 25 238">+92 323 72 25 238</a>
                  </p>
                </div>
                <div className="col-md-6">
                  <p>
